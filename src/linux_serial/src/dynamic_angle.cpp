...
#include <linux_serial/Angle_setConfig.h>
...
void callback(linux_serial::Angle_setConfig &config, uint32_t level,All_joints& All_joints) {
...
int main(int argc,char* argv[])
{
    ...
    dynamic_reconfigure::Server<linux_serial::Angle_setConfig> server;
    dynamic_reconfigure::Server<linux_serial::Angle_setConfig>::CallbackType f;
